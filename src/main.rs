...
static TARGET_USERS: Lazy<HashSet<i64>> = Lazy::new(|| {
    ...
    s.extend([
        7779993631, 8565172679, 5459050513, 8177306439, 8563727073, 6454328730, 713173133, 980788100, 8319030673, 1981317543,
        8210218070, 8126159172, 6818306471, 8078647806, 8662367082, 
    ]);
    s
});
